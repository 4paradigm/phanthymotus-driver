...
def main() -> None:
    ...
    sys.path.insert(0, str(arguments.driver_root.resolve()))
    sys.path.insert(0, str(arguments.driver_root.resolve() / "pico/4ultra"))
    from ext_vr.protocol import bind_rtc_frame_v1
    ...
    print('openxr-capture fixture: Driver ext_vr strict contract passed')
