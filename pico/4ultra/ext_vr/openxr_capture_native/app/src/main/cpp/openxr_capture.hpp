...
class OpenXrCapture final {
 ...
 private:
  ...
  XrAction trigger_click_{XR_NULL_HANDLE}, trigger_touch_{XR_NULL_HANDLE};
  XrAction grip_click_{XR_NULL_HANDLE};
  XrAction thumbstick_click_{XR_NULL_HANDLE}, thumbstick_touch_{XR_NULL_HANDLE};
  XrAction primary_click_{XR_NULL_HANDLE}, primary_touch_{XR_NULL_HANDLE};
  XrAction secondary_click_{XR_NULL_HANDLE}, secondary_touch_{XR_NULL_HANDLE};
