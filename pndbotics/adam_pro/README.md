...
The robot has not arrived yet. The pinned ROS2 messages and public Adam Pro example have been contract-checked, but Docker/ARM64, DDS discovery, motor ordering, joint limits and physical motion remain to be validated on the delivered robot.
