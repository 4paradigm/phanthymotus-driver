...
class StatePlugin:
    ...
    def dispatch(self, action, args):
        ...
        if action == "info":
            ...
            return {"state": "running"}
        if action in ("imu", "joints", "joint_state", "battery", "loco_state", "odometry", "remote_controller"):
            path = {"imu": "state/imu", "joints": "state/joints", "joint_state": "state/joint_state", "battery": "state/battery", "loco_state": "loco/state", "odometry": "state/odometry", "remote_controller": "state/remote_controller"}[action]
