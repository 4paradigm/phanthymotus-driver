...
class ArmControlPlugin:
    ...
    def _validate_move(self, joint_name: str, target_value):
        ...
        # RobotEra's shared router reports competing endpoints as
        # ``other_publishers``; older Q5 builds exposed a same-name count.
        # Accept either shape without weakening the duplicate-owner guard.
        same_name_count = int(status.get("same_name_publisher_count", 1))
