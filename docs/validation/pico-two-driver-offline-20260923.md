...
本记录只覆盖 #329 独立 PICO Driver 候选，工作树 `pico-two-driver-20260923`。本次代码与文档一起交付，不以旧四卡记录代替本轮结果。共享协议及组合验证由主任务统一；没有修改机器人bundle、Core或ActuCore，本节离线阶段没有部署、申请BOT或操作设备。后续部署与并发更新见[现场记录](two-driver-site-20260923.md)。
